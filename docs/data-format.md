...
Search snapshots are generated by `krx-rule-index` in `krx-rule-mcp` and should be stored outside the `krx-rule-markdown` corpus. The recommended local directory is `KRX_RULE_INDEX_DIR`:
